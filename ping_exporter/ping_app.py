...
from ping_exporter.prometheus_metrics import prometheus_text, lookup_attribute_to_name
...
def make_app(*args, **kwargs):
    ...
    app.add_url_rule('/favicon.ico', "favicon", redirect_to="https://cdn.fuga.cloud/fuga-assets/dist/images/favicon.ico")
